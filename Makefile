...
# TODO: make these paths versatile
LIBMAPLE_PATH := $(SRCROOT)/../libmaple/libmaple
WIRISH_PATH := $(SRCROOT)/../libmaple/wirish
SUPPORT_PATH := $(SRCROOT)/../libmaple/support
LIBRARIES_PATH := $(SRCROOT)/../libmaple/libraries
...
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/libmaple
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/libmaple/usb   # The USB module is kept separate
LIBMAPLE_MODULES += $(LIBMAPLE_MODULE_SERIES) # STM32 series submodule in libmaple
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/wirish

# Official libraries:
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/libraries/Servo
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/libraries/LiquidCrystal
LIBMAPLE_MODULES += $(SRCROOT)/../libmaple/libraries/Wire
